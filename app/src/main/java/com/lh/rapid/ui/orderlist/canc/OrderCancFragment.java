...
public class OrderCancFragment extends BaseFragment implements OrderCancContract.View {
    ...
    @Inject
    OrderCancPresenter mPresenter;

    public static BaseFragment newInstance() {
        OrderCancFragment orderAllFragment = new OrderCancFragment();
