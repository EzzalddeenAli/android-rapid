package com.lh.rapid.ui.orderlist.distribution;
 ...
 */
public class OrderDistributionPresenter implements OrderDistributionContract.Presenter {

    private final CompositeDisposable disposables = new CompositeDisposable();
    private OrderDistributionContract.View mView;
    ...
    @Inject
    public OrderDistributionPresenter(CommonApi commonApi) {
        mCommonApi = commonApi;
    }

    @Override
    public void attachView(@NonNull OrderDistributionContract.View view) {
        mView = view;
    }
