package com.lh.rapid.ui.orderlist.finished;
 ...
 */
public class OrderFinishedPresenter implements OrderFinishedContract.Presenter {

    private final CompositeDisposable disposables = new CompositeDisposable();
    private OrderFinishedContract.View mView;
    ...
    @Inject
    public OrderFinishedPresenter(CommonApi commonApi) {
        mCommonApi = commonApi;
    }

    @Override
    public void attachView(@NonNull OrderFinishedContract.View view) {
        mView = view;
    }
