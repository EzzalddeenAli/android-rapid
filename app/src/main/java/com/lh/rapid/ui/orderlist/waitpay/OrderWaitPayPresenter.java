 ...
 */
public class OrderWaitPayPresenter implements OrderWaitPayContract.Presenter {

    private final CompositeDisposable disposables = new CompositeDisposable();
    private OrderWaitPayContract.View mView;
    ...
    @Inject
    public OrderWaitPayPresenter(CommonApi commonApi) {
        mCommonApi = commonApi;
    }

    @Override
    public void attachView(@NonNull OrderWaitPayContract.View view) {
        mView = view;
    }
