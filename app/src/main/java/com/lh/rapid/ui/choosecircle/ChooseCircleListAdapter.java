...
public class ChooseCircleListAdapter extends BaseAdapter {


    private ChooseCircleActivity mContext;
    private List<GeoCoderResultEntity.ResultBean.PoisBean> mRecyclerViewGeoCoderData;

    public ChooseCircleListAdapter(ChooseCircleActivity context, List<GeoCoderResultEntity.ResultBean.PoisBean> recyclerViewGeoCoderData) {
