package com.lh.rapid.ui.orderlist.preparing;
 ...
 */
public class OrderPreparingPresenter implements OrderPreparingContract.Presenter {

    private final CompositeDisposable disposables = new CompositeDisposable();
    private OrderPreparingContract.View mView;
    ...
    @Inject
    public OrderPreparingPresenter(CommonApi commonApi) {
        mCommonApi = commonApi;
    }

    @Override
    public void attachView(@NonNull OrderPreparingContract.View view) {
        mView = view;
    }
