...
public class ChooseCircleAdapter extends RecyclerView.Adapter<ChooseCircleAdapter.ChooseLocationViewHolder> {


    private Context context;
    private List<GeoCoderResultEntity.ResultBean.PoisBean> mPoisBeen;

    public ChooseCircleAdapter(Context context, List<GeoCoderResultEntity.ResultBean.PoisBean> poisBeanList) {
