...
public class OrderDistributionFragment extends BaseFragment implements OrderDistributionContract.View {
    ...
    @Inject
    OrderDistributionPresenter mPresenter;

    public static BaseFragment newInstance() {
        OrderDistributionFragment orderAllFragment = new OrderDistributionFragment();
