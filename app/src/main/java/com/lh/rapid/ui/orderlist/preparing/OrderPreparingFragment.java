...
public class OrderPreparingFragment extends BaseFragment implements OrderPreparingContract.View {
    ...
    @Inject
    OrderPreparingPresenter mPresenter;

    public static BaseFragment newInstance() {
        OrderPreparingFragment orderAllFragment = new OrderPreparingFragment();
