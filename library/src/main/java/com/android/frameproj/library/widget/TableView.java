...
public class TableView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            rowHeight = typedArray.getDimensionPixelSize(R.styleable.TableView_rowHeight, ScreenUtil.dipToPx(getContext(), 36));
            ...
            textSize = typedArray.getDimensionPixelSize(R.styleable.TableView_textSize, ScreenUtil.dipToPx(getContext(), 10));
            ...
            headerTextSize = typedArray.getDimensionPixelSize(R.styleable.TableView_headerTextSize, ScreenUtil.dipToPx(getContext(), 10));
            headerTextColor = typedArray.getColor(R.styleable.TableView_headerTextColor, Color.parseColor("#999999"));
            typedArray.recycle();
        } else {
            unitColumnWidth = 0;
            rowHeight = ScreenUtil.dipToPx(getContext(), 36);
            dividerWidth = 1;
            dividerColor = Color.parseColor("#E1E1E1");
            textSize = ScreenUtil.dipToPx(getContext(), 10);
            textColor = Color.parseColor("#999999");
            headerColor = Color.parseColor("#00ffffff");
            headerTextSize = ScreenUtil.dipToPx(getContext(), 10);
